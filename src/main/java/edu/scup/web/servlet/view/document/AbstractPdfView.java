...
/**
 * copied from org.springframework.web.servlet.view.document,replace itext4 with itext5
 */
public abstract class AbstractPdfView extends AbstractView {
    ...
    protected final void renderMergedOutputModel(
        ...
        beforeDocumentOpen(model, document, writer);
    ...
    protected void beforeDocumentOpen(Map<String, Object> model, Document document, PdfWriter writer) {
    }
}
